...
**Футболіст** — спортсмен, який у складі команди бере участь у змаганнях і є працівником компанії, яку ця команда представляє.

**Футболіст-ветеран** — футболіст або футболіст-легіонер, який останні чотири сезони своєї кар'єри брав участь у змаганнях у складі однієї команди.
...
1. У термін, встановлений Оргкомітетом, кожен представник повинен надати заявкові документи:
   ...
   * додатково за одну команду може бути заявлено не більше одного футболіста-легіонера, який є футболістом-ветераном;
   * за одну команду може бути заявлено не більше двох футболістів-професіоналів, що були включені в заявку на участь у змаганнях Чемпіонату аба Першості будь якої з ліг менш ніж у трьох сезонах;
   * за додатковим запитом Оргокмітету представник команди у триденний строк (але не піздніше дати офіційного старту змагань до яких подається заявка) повинен надати інформацію, яка дозволяє однозначно і чітко визначити приналежність футболіста або футболіста-легіонера до компанії співробітником якої він є згідно з заявкою;
   * будь яка інформація, що зазначена у заявкових документах, вважається актуальною на момент подачі заявки на участь у змаганнях;
2. Відповідальність за правдивість і правильність оформлення поданих заявкових документів несе представник команди.
...
1. Офіційні особи команд перед початком матчів чемпіонату та кубку зобов’язані:
   * За 10 хвилин до початку матчу друкованими літерами вписати до протоколу матчу прізвища та імена п’яти футболістів основного складу та не більше дев’яти запасних футболістів.
...
2. Арбітри мають право зупиняти, тимчасово припиняти, чи відміняти матч через будь-яке зовнішнє втручання, а також через неспортивну поведінку футболістів однієї з команд.
3. Арбітри мають право приймати будь-які рішення, що відповідають «Правилам гри у футзал» або обов’язкам арбітра, які визначені ФІФА, УЕФА та Регламентом. Арбітр має виключні повноваження із застосування та трактування «Правил гри у футзал».
4. Арбітр повинен протягом тридцяти хвилин після закінчення матчу оформити протокол матчу. У протоколі матчу арбітр повинен викласти інформацію про результат матчу, авторів забитих голів і будь-які інциденти, що виникли до, під час та після матчу.
...
3. За кожні три жовті картки, отримані в матчах, футболіст підлягає відстороненню на один матч.
